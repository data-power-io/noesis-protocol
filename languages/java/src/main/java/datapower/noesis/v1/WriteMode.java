...
/**
 * Protobuf enum {@code datapower.noesis.v1.WriteMode}
 */
public enum WriteMode
  ...
  /**
   * <pre>
   * Merge/upsert based on RecordMsg.op (CDC mode)
   * </pre>
   *
   * <code>MERGE = 2;</code>
   */
  ...
  /**
   * <pre>
   * Replace all data (batch mode)
   * </pre>
   *
   * <code>OVERWRITE = 3;</code>
   */
  OVERWRITE(3),
  UNRECOGNIZED(-1),
  ;
  ...
  // @@protoc_insertion_point(enum_scope:datapower.noesis.v1.WriteMode)
}
