...
/**
 * Protobuf enum {@code datapower.noesis.v1.SourceType}
 */
public enum SourceType
  ...
  /**
   * <code>ICEBERG_TABLE = 1;</code>
   */
  ICEBERG_TABLE(1),
  /**
   * <code>KAFKA_TOPIC = 2;</code>
   */
  KAFKA_TOPIC(2),
  UNRECOGNIZED(-1),
  ;
   ...
   * <code>ICEBERG_TABLE = 1;</code>
   */
  public static final int ICEBERG_TABLE_VALUE = 1;
  /**
   * <code>KAFKA_TOPIC = 2;</code>
   */
  public static final int KAFKA_TOPIC_VALUE = 2;
  ...
  public static SourceType forNumber(int value) {
    switch (value) {
      ...
      case 1: return ICEBERG_TABLE;
      case 2: return KAFKA_TOPIC;
      default: return null;
    }
  }
  ...
  public static final com.google.protobuf.Descriptors.EnumDescriptor
      getDescriptor() {
    return datapower.noesis.v1.Pipeline.getDescriptor().getEnumTypes().get(0);
  }
  ...
  // @@protoc_insertion_point(enum_scope:datapower.noesis.v1.SourceType)
}
