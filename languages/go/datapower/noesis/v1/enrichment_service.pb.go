...
const file_datapower_noesis_v1_enrichment_service_proto_rawDesc = "" +
	...
	"\n" +
	"GetHistory\x12(.datapower.noesis.v1.FlinkHistoryRequest\x1a).datapower.noesis.v1.FlinkHistoryResponseB\x88\x01\n" +
	"\x13datapower.noesis.v1B\x1bFlinkEnrichmentServiceProtoP\x01ZRgithub.com/data-power-io/noesis-protocol/languages/go/datapower/noesis/v1;noesisv1b\x06proto3"
